...
//            Jon (8/23/17) - Tried to get Twitter to work
//            Jon (8/29/17) - Got Twitter's API to work, got Spotify API to start responding, & configured OMDb API to run a function
